    ...
    Object.entries(models).forEach(([modelName, modelEntry]) => {
      ...
      modelDetails.forEach((detailRaw) => {
        ...
        details.push({
          ...
          service_tier: normalizeServiceTier(
            detailRaw.service_tier ?? detailRaw.serviceTier ?? detailRaw.ServiceTier
          ),
          requested_fast_mode:
            detailRaw.requested_fast_mode === true ||
            detailRaw.requestedFastMode === true ||
            detailRaw.RequestedFastMode === true,
